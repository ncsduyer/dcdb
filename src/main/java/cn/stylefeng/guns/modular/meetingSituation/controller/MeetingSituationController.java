package cn.stylefeng.guns.modular.meetingSituation.controller;
 ...
 */
@Controller
@RequestMapping("/meetingSituation")
public class MeetingSituationController extends BaseController {
