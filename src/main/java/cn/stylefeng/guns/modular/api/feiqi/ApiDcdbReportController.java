//package cn.stylefeng.guns.modular.api.feiqi;
//
...
////    @ResponseBody
////    public void export( @RequestParam(value = "type",defaultValue = "1") Integer type, HttpServletRequest request, HttpServletResponse response) throws Exception {
////
////        //excle模板文件名
